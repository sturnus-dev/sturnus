...
llmrouter sits in the path of every LLM request and handles your provider API keys, so security reports are taken seriously.
...
- GitHub's [private vulnerability reporting](https://github.com/dannyboland/llmrouter/security/advisories/new) (preferred)
...
- llmrouter forwards to the upstream base URLs you configure; it is not a general-purpose open proxy. Issues that require an attacker to already control the config are generally out of scope.
